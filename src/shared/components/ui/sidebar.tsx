...
const sidebarMenuButtonVariants = cva(
    "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-3 text-left text-sm outline-hidden ring-sidebar-ring " +
    ...
    "data-[active=true]:text-white data-[active=true]:shadow-[0_0_20px_rgba(251,146,60,0.45)] " +
    "group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! " +
    "[&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
    {
      variants: {
        variant: { default: "", outline: "" },
        size: { default: "h-10", sm: "h-9 text-xs", lg: "h-12 text-base" }
      },
